...
DüzenlemeFormu.addComponents(YeniSistem)
  ...
  if(interaction.options.getSubcommand() === 'admin-liste') {
    ...
    const Sahip = new EmbedBuilder()
      ...
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
    if(interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1031841616023007282") return await interaction.reply({embeds: [Sahip]})
