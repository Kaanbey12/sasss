...
module.exports = {
  ...
  dbl: false, 
  name: ['karaliste'],  
  description: 'Darkadia Uptime karaliste sistemi.',
  options: [
    { 
      name: "ekle",
...
async execute(client, interaction) {
  ...
  const Sahip = new EmbedBuilder()
    ...
    .setTimestamp()
  if(interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1167500081281368146" && interaction.user.id !== "1031841616023007282") return await interaction.followUp({embeds: [Sahip]})
  ...
  const KaraListe = new EmbedBuilder()
    ...
    .setAuthor({name: interaction.user.username, iconURL: interaction.user.avatarURL()}) 
    .setDescription(`> Darkadia Uptime karalistedeki üyelerin listesi`)
    .addFields(
      {
