...
async execute(client, interaction) { 
  ...
  const ParaYok = new EmbedBuilder()
    ...
    .setDescription(`${Emojis.Çarpı} Slot oynamak istediğin **${Miktar} AD** bakiyende bulunmuyor.`)
...
> ${Emojis.Para} Kazanılan para: **${Miktar*3} AD**  -  Kazanç: **${Miktar*3-Miktar} AD**
`)
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
...
> ${Emojis.Para} Kaybedilen para: **${Miktar} AD**
`)
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
