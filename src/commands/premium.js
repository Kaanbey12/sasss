...
module.exports = {
  ...
  dbl: false, 
  name: ['premium'],  
  description: 'DarkAdia premium sistemi.',
  options: [
    { 
      name: "ver",
...
async execute(client, interaction) {
  ...
  const Sahip = new EmbedBuilder()
    ...
    .setTimestamp()
  if(interaction.user.id !== "1142158141446950912" && interaction.user.id !== "1142158141446950912" && interaction.user.id !== "1142158141446950912" && interaction.user.id !== "1142158141446950912") return await interaction.followUp({embeds: [Sahip]})
  ...
  const Sahip = new EmbedBuilder()
    ...
    .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
    .setTimestamp()
  if(interaction.user.id !== "1031841616023007282" && interaction.user.id !== "3615082263103184161602300728200248065" && interaction.user.id !== "1031841616023007282" && interaction.user.id !== "1031841616023007282") return await interaction.followUp({embeds: [Sahip]})
